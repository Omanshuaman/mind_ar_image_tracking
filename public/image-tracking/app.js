...
OX.init(config)
  .then((rendererCanvas) => {
    ...
    // Add images for tracking
    const imageId = "custom_image_id";
    const imageURL =
      "https://res.cloudinary.com/dd3c4j1sm/image/upload/v1705043225/1b48b5131734509.619b67aa0bff1_2_cxkljv.jpg";
    OX.addImage(imageURL, imageId);
